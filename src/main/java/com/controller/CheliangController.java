    ...
    */
    ...
    public R save(@RequestBody CheliangEntity cheliang, HttpServletRequest request){
        ...
        Wrapper<CheliangEntity> queryWrapper = new EntityWrapper<CheliangEntity>()
            ...
            .eq("cheliang_zhuangtai_types", cheliang.getCheliangZhuangtaiTypes())
...
//                            cheliangEntity.setCheliangZhuangtaiTypes(Integer.valueOf(data.get(0)));   //车辆状态 要改的
//                            cheliangEntity.setCheliangJiage(data.get(0));                    //车辆价格 要改的
//                            cheliangEntity.setCheliangYajinJiage(data.get(0));                    //所需押金 要改的
//                            cheliangEntity.setCheliangNewJiage(data.get(0));                    //现价/天 要改的
